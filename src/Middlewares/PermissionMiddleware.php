...
namespace Georgie\Module\Middlewares;

use Closure;
use Georgie\Module\Exceptions\PermissionDenyException;
 ...
 *
 * @package Georgie\Module\Middlewares
 */
class PermissionMiddleware
{
     ...
     *
     * @return mixed
     * @throws \Georgie\Module\Exceptions\PermissionDenyException
     */
